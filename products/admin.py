...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'price', 'promocion', 'price_promotion', 'stock_quantity', 'category', 'created_at', 'updated_at') # Define quais campos do modelo serão exibidos na lista de objetos na interface administrativa do Django.
